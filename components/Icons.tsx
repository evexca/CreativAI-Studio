...
export const MusicIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-16c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 6l12-3"></path>
    </svg>
);

export const UserIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5 text-brand-text-secondary" }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const VisionIcon: React.FC<{ className?: string }> = ({ className = "mx-auto h-12 w-12 text-brand-text-secondary" }) => (
...
export const SettingsIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5 text-brand-text-secondary" }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
